...
bin/illinois-coref-ace-server.sh -p 9094 >& logs/coref.log &
...
# bin/illinois-verb-srl-server-new.sh -p 14811 >& logs/verb-srl-new.log &

# bin/illinois-nom-srl-server-new.sh -p 14911 >& logs/nom-srl-new.log &

bin/illinois-wikifier-server.sh -p 15231 >& logs/wikifier.log &

bin/illinois-ner-extended-server.pl ner-basic 9096 configs/conll.config >& logs/ner-ext-conll.log &

bin/illinois-ner-extended-server.pl ner-ext 9097 configs/ontonotes.config >& logs/ner-ext-ontonotes.log &
