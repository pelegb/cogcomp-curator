...
* 
*/
public class IllinoisCorefServer extends IllinoisAbstractServer{
...
//	}
    ...
    public IllinoisCorefServer(Class c){
        super(c);
    }
    
    public IllinoisCorefServer(Class c, int threads, int port, String configFile){
...
//		int port = 9090;
//		String configFile = "";
        IllinoisCorefServer s = new IllinoisCorefServer(IllinoisCorefServer.class);
...
//		configFile = line.getOptionValue("config", "");
		...
		try {
		    handler = new IllinoisCorefHandler(s.configFile);
		}
		catch ( TException e ) {
		    s.logger.error( "ERROR: IllinoisCorefServer(): couldn't instantiate IllinoisCorefHandler: " +
				  e.getMessage() );
		    System.exit( -1 );
		}
