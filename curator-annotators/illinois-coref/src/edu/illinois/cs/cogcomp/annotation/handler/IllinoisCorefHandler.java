 ...
 * 
 */
public class IllinoisCorefHandler extends IllinoisAbstractHandler implements ClusterGenerator.Iface {
	...
	public IllinoisCorefHandler(String configFilename) throws TException {
        ...
        super("Illinois Coreference Resolver", "0.2", "illinoiscoref");
...
//                mentions.add(m);
//            }
            addMentions(mentions, record, doc, 0);
...
//					mentions.add(m);
//				}
                addMentions(mentions, record, doc, offset);
            }
