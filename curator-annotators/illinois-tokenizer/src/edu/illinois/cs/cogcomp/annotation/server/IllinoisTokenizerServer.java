 ...
 * 
 */
public class IllinoisTokenizerServer extends IllinoisAbstractServer{
...
//	}
    ...
    public IllinoisTokenizerServer(Class c){
        super(c);
    }
    
    public IllinoisTokenizerServer(Class c, int threads, int port, String configFile){
        super(c, threads, port, configFile);
    }
    
	public static void main(String[] args) {
		MultiLabeler.Iface tokenizer = new IllinoisTokenizerHandler();
		MultiLabeler.Processor processor = new MultiLabeler.Processor(tokenizer);
//		int threads = 1;
//		int port = 9090;
        IllinoisTokenizerServer s = new IllinoisTokenizerServer(IllinoisTokenizerServer.class);
...
//			hformat.printHelp(
//					"java " + IllinoisTokenizerServer.class.getName(), options,
//					true);
//			System.exit(1);
//		}
