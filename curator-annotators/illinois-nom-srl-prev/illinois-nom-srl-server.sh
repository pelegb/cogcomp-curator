...
MODEL_JAR=illinoisSRL-nom-models-3.0.5.jar
...
#COMPONENT_CLASSPATH=$COMPONENTDIR/illinois-nom-srl-server.jar:$CURATOR_BASE:$COMPONENTDIR/illinois-abstract-server.jar
...
#LIB_CLASSPATH=$CURATOR_BASE:$LIBDIR/$BIN_JAR:$LIBDIR/commons-cli-1.2.jar:$LIBDIR/commons-collections-3.2.1.jar:$LIBDIR/commons-configuration-1.6.jar:$LIBDIR/commons-lang-2.5.jar:$LIBDIR/commons-logging-1.1.1.jar:$LIBDIR/coreUtilities-0.1.4.jar:$LIBDIR/curator-interfaces-0.7.jar:$LIBDIR/edison-0.2.10.jar:$LIBDIR/jwnl-1.4_rc3.jar:$LIBDIR/LBJLibrary-2.8.2.jar:$LIBDIR/libthrift.jar:$LIBDIR/logback-classic-0.9.28.jar:$LIBDIR/logback-core-0.9.28.jar:$LIBDIR/slf4j-api-1.6.1.jar:$LIBDIR/snowball-1.0.jar
...
CMD="java -cp $CLASSPATH -Dhome=$CURATOR_BASE -Xmx6G edu.illinois.cs.cogcomp.annotation.server.IllinoisNomSRLServer -c $CONFIGDIR/srl-config.properties  $@"
