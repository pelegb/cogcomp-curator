 ...
 * 
 */
public class IllinoisPOSServer extends IllinoisAbstractServer{
...
//	}
    ...
    public IllinoisPOSServer(Class c){
        super(c);
    }
    
    public IllinoisPOSServer(Class c, int threads, int port, String configFile){
...
//		int port = 9090;
//		String configFile = "";
        IllinoisPOSServer s = new IllinoisPOSServer(IllinoisPOSServer.class);
...
//			hformat.printHelp("java " + IllinoisPOSServer.class.getName(),
//					options, true);
//			System.exit(1);
//		}
...
//			threads = 2;
//		}
//		// force threads to be 1 because we cannot handle more
//		threads = 1;
//
//		configFile = line.getOptionValue("config", "");
		...
		Labeler.Iface handler = new IllinoisPOSHandler(s.configFile);
