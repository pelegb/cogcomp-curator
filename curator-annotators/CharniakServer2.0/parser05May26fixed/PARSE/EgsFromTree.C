...
//   assert(trm);
  if ( NULL == trm ) 
    throw CharniakException( "NULL Term pointer 'trm'." );
...
//       assert(lhs);
      ...
      if ( NULL == lhs ) 
	throw CharniakException( "NULL pointer 'lhs'." );
...
//       assert(itm);
      ...
      if ( NULL == itm )
	throw CharniakException( "NULL Item pointer 'itm'." );
