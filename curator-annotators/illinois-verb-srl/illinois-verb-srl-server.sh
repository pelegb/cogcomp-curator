...
MODEL_JAR=illinoisSRL-verb-models-$MODELVERSION.jar
...
CMD="java -cp $CLASSPATH -Dhome=$CURATOR_BASE -Xmx4G edu.illinois.cs.cogcomp.annotation.server.IllinoisVerbSRLServer -c $CONFIGDIR/srl-config.properties  $@"
