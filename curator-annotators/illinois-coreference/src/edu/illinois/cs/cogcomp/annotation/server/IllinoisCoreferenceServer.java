...
import edu.illinois.cs.cogcomp.annotation.handler.IllinoisCoreferenceHandler;
import edu.illinois.cs.cogcomp.thrift.cluster.ClusterGenerator;
import edu.illinois.cs.cogcomp.thrift.labeler.Labeler;

public class IllinoisCoreferenceServer
{
  

     

        private static Logger logger = LoggerFactory.getLogger(IllinoisCoreferenceServer.class);
        ...
        public static void main(String[] args) throws Exception 
        {
            ...
            try {
                ...
                hformat.printHelp("java " + IllinoisCoreferenceServer.class.getName(),
                                  options, true);
                System.exit(1);
            }
            ...
            ClusterGenerator.Iface handler = new IllinoisCoreferenceHandler( );
